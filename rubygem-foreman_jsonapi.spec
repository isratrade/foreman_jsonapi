...
%global gem_name foreman_jsonapi
...
Summary: Foreman JSONAPI plugin (v21) is based on v2 controllers but uses the response format according to the jsonapi.org specification.
...
URL: https://github.com/isratrade/foreman_jsonapi
...
BuildArch: noarch
Provides: %{?scl_prefix}rubygem(foreman_jsonapi) = %{version}

Requires: %{?scl_prefix}rubygem-active_model_serializers

%description
Foreman JSONAPI Plugin
